...
Update_InstTable("INSTALL/ASSETS/DST_OPENTUNA-INSTALLER"  , "DST_OPENTUNAINSTALLER"  , MC_INST_TABLE.source, MC_INST_TABLE.target, MC_INST_TABLE.dirs)
...
Update_InstTable("INSTALL/ASSETS/POPSTARTER"  , "POPSTARTER"  , MC_INST_TABLE.source, MC_INST_TABLE.target, MC_INST_TABLE.dirs)
