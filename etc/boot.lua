  ...
  LNG_IMPP1 = "FMCB Installer's classic installation formats"
  ...
  LNG_IMPMP2 = "Advanced or PSX Install"
  LNG_IMPMP3 = "Custom Install"
  ...
  LNG_WANNAQUIT = "Add an OpenTuna Icon Exploit to launch mc?/BOOT/BOOT.ELF from the PS2 Browser,\niideal entry for consoles which can not auto boot exploits.\n(Make sure you have installed at least 1 form of UMCS before installing OpenTuna. This ensures the presence of required\nmc?:/BOOT/BOOT.ELF)"
  LNG_YES = "Yes"
  LNG_YESALT = "Exit and Launch OpenTuna Installer for mc?:/BOOT/BOOT.ELF"
  LNG_NO = "No"
  LNG_NOALT = "Go Back to KELFBinder Menu"
  LNG_PLS_WAIT = "Please Wait..."
  LNG_RWLE = "Exit to OpenTuna Installer\n(Requires at least\n1 installation of UMCS\nto function properly.)"
  ...
  LNG_COMPAT1 = "You can still use it to install for OpenTuna or other consoles."
  ...
  LNG_INSTALLING_EXTRA = "Installing additional files..."
  LNG_UNFORMATTED_CARD = "unformatted"
  LNG_EXTRA_INSTALL_ENABLE = "Full Install"
  LNG_EXTRA_INSTALL_DISABLE = "Exploit Only Install"
  ...
  LNG_WARN_DVDPLAYER_PROPIETARY_SOFTWARE = "DVDPlayer software is not bundled due to copyright."
