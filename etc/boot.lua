  ...
  LNG_MM1 = "Welcome to KELFBinder: OSDMENU Installer MOD by Ripto"
  LNG_MM2 = "Install PS2BBL-OSDMENU Exploits"
  LNG_MM3 = "Install DVDPlayer Updates"
